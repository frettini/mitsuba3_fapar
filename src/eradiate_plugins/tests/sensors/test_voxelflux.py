...
def test_energy_conservation(variant_scalar_rgb):
    ...
    res = res.numpy()
    flux_in = res[1, :, 0, 0, 0].sum() + res[0, 0, 1, 0, 0] + res[0, 1, 0, 1, 0] + res[0, 2, 0, 0, 1]
    flux_out = res[0, :, 0, 0, 0].sum() + res[1, 0, 1, 0, 0] + res[1, 1, 0, 1, 0] + res[1, 2, 0, 0, 1]
