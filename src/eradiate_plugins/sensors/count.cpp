...
public:
    ...
    CountSensor(const Properties &props) : Base(props) {
        ...
        m_sensor_filter = +SensorFilterFlags::All | +SensorFilterFlags::Exclusive;
    }
...
MI_IMPLEMENT_CLASS_VARIANT(CountSensor, Sensor)
MI_EXPORT_PLUGIN(CountSensor, "Count Sensor")
