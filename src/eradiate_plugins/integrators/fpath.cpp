...
class FPathIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    ...
    std::string to_string() const override {
        return tfm::format("FPathIntegrator[\n"
            "  min_depth = %u,\n"
            "  max_depth = %u,\n"
            "  rr_depth = %u\n"
            "]", m_min_depth, m_max_depth, m_rr_depth);
    }
...
MI_IMPLEMENT_CLASS_VARIANT(FPathIntegrator, MonteCarloIntegrator)
MI_EXPORT_PLUGIN(FPathIntegrator, "Filtered Path Tracer integrator");
